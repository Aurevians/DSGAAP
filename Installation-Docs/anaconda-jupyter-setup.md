# Anaconda + Python 3.13 + Jupyter Setup Runbook

## Apple Silicon macOS

A practical, end-to-end team runbook for installing and configuring **Anaconda on Apple Silicon macOS** and preparing a clean **Python 3.13.11** development environment with **Conda**, **pyenv**, **JupyterLab**, and **Jupyter Notebook**.

This document is intended to be the **single source of truth** for the team's Anaconda and Jupyter workstation setup. It covers installation, configuration, validation, standard daily workflows, and troubleshooting, including corporate environments that use SSL inspection such as Zscaler.

### What This Setup Provides

After completing this runbook, the workstation will have:

- Anaconda installed through Homebrew
- Conda available without automatically activating the `base` environment
- Python 3.13.11 managed by `pyenv` for normal terminal Python usage
- A dedicated Conda environment named `py313`
- JupyterLab and Jupyter Notebook installed inside `py313`
- A registered `Python 3.13.11 (py313)` Jupyter kernel
- Clear separation between the normal terminal Python and the Conda development environment
- Validation and troubleshooting procedures for common setup issues

> **Scope:** Apple Silicon (`arm64`) Macs using Zsh and Homebrew.
>
> **Security:** Do not leave Conda SSL verification disabled as a permanent solution. Corporate CA/Zscaler issues should be resolved using an IT-approved CA configuration.

---

## How to Use This Runbook

- **New setup:** Follow Sections 1 through 19 in order.
- **Daily use:** Go directly to Sections 23 and 24.
- **Problems:** Use Section 20, Troubleshooting Guide.
- **Command lookup:** Use Section 21, Quick Reference.
- **Team standards:** Review Section 22, Team Operational Guidelines.
